(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0731/0370/4379/t/1/assets/appstle-subscription.js?v=1683034714");
      ...
      RS.Config = {
        ...
        "shop": "mastering-ecommerce-dev.myshopify.com",
